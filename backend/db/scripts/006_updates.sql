...
DROP FUNCTION IF EXISTS public.a_person_search(character varying, character varying, character varying, character varying, character varying, boolean, boolean, boolean, boolean, boolean, boolean);

CREATE FUNCTION public.a_person_search(

-- Add p_has_multiple_icas filter to a_households_search and a_fishers_search

-- Drop existing signatures before recreating with new parameter
DROP FUNCTION IF EXISTS public.a_households_search(
  ...
  character varying, character varying, boolean, boolean, boolean, boolean, boolean
);
...
-- Drop existing fishers search signature before recreating with new parameter
DROP FUNCTION IF EXISTS public.a_fishers_search(
  character varying, character varying, character varying, character varying,
  integer, boolean, boolean, character varying, character varying, boolean, boolean, boolean
);

...
async function loadGrievances () {
  ...
  error.value = ''
  try {
    const r = await axiosSecure.get(`/households/${encodeURIComponent(props.pah)}/grievances`)
...
async function submitGrievance () {
  ...
  saveError.value = ''
  try {
    await axiosSecure.post(`/households/${encodeURIComponent(props.pah)}/grievances`, {
